...
func setupKeeper(t *testing.T) (*Keeper, sdk.Context, []sdk.StoreKey) {
	...
	srcKeeper := NewKeeper(encodingConfig.Marshaler, keyWasm, pk.Subspace(wasmTypes.DefaultParamspace), authkeeper.AccountKeeper{}, nil, stakingkeeper.Keeper{}, distributionkeeper.Keeper{}, oraclekeeper.Keeper{}, nil, tempDir, wasmConfig, "", nil, nil)
