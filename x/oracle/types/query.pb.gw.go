...
var (
	pattern_Query_ExchangeRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"konstellation", "oracle", "exchange_rate"}, "", runtime.AssumeColonVerbOpt(true)))
)
