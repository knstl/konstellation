...
// source: issue/coin_issue_denom.proto
...
func (*CoinIssueDenom) Descriptor() ([]byte, []int) {
	return fileDescriptor_486fe8acdc03bba2, []int{0}
}
...
func init() { proto.RegisterFile("issue/coin_issue_denom.proto", fileDescriptor_486fe8acdc03bba2) }

var fileDescriptor_486fe8acdc03bba2 = []byte{
	// 157 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *CoinIssueDenom) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Id != 0 {
		i = encodeVarintCoinIssueDenom(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintCoinIssueDenom(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintCoinIssueDenom(dAtA []byte, offset int, v uint64) int {
	offset -= sovCoinIssueDenom(v)
	base := offset
	for v >= 1<<7 {
...
func (m *CoinIssueDenom) Size() (n int) {
	...
	l = len(m.Denom)
	if l > 0 {
		n += 1 + l + sovCoinIssueDenom(uint64(l))
	}
	if m.Id != 0 {
		n += 1 + sovCoinIssueDenom(uint64(m.Id))
	}
	return n
}

func sovCoinIssueDenom(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozCoinIssueDenom(x uint64) (n int) {
	return sovCoinIssueDenom(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *CoinIssueDenom) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowCoinIssueDenom
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthCoinIssueDenom
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipCoinIssueDenom(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipCoinIssueDenom(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowCoinIssueDenom
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthCoinIssueDenom
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupCoinIssueDenom
			}
			depth--
		case 5:
			iNdEx += 4
