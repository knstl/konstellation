...
func setTotalSupply(app *KonstellationApp, ctx sdk.Context, accAmt sdk.Int, totalAccounts int) {
...
func addTestAddrs(app *KonstellationApp, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
func saveAccount(app *KonstellationApp, ctx sdk.Context, addr sdk.AccAddress, initCoins sdk.Coins) {
