...
func GetWasmOpts(appOpts servertypes.AppOptions) []wasm.Option {
	...
	wasmOpts = append(wasmOpts, wasmkeeper.WithGasRegister(NewDarcWasmGasRegister()))
...
func New(
	...
	govRouter.AddRoute(govtypes.RouterKey, govtypes.ProposalHandler).
		...
		AddRoute(bech32ibctypes.RouterKey, bech32ibcmodule.NewBech32IBCProposalHandler(app.Bech32IbcKeeper)).
	...
	app.BankbaseKeeper = bankbaseKeeper
	...
	app.mm = module.NewManager(
		...
		//oracleModule,
		transferModule,
		gravitymodule.NewAppModule(gravityKeeper, app.BankKeeper),
		bech32ibc.NewAppModule(appCodec, bech32IbcKeeper),
...
// LegacyAmino returns knstld amino codec.
//
...
// AppCodec returns knstld's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns knstld's InterfaceRegistry
...
func (app *App) registerUpgradeHandlers() {
	app.UpgradeKeeper.SetUpgradeHandler("v0.45", func(ctx sdk.Context, plan upgradetypes.Plan, _ module.VersionMap) (module.VersionMap, error) {
