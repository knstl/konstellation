...
require (
	...
	//google.golang.org/grpc v1.48.0          Removed as it is no longer reuired in 0.46.1 check : https://github.com/cosmos/cosmos-sdk/blob/v0.46.1/UPGRADING.md#go-api-changes
